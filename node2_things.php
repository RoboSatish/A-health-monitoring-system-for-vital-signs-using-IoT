                ...
                success: function (data, textStatus, xhr) {
                    $.each(data, function (i, item) {
                        if (i == 'feeds') {
                            var ubound = item.length;
							//document.write(ubound);
							$('#txtField6').val(item[ubound - 1].field6);
							 f3=item[ubound - 1].field6
							//document.write(f3);
							//document.write("<br>");
...
<tr>
                        ...
                        <td width="80%" valign="top">
                            <table>
<tr><td>Field 1:</td><td><input id="txtField4" type="text" name="f11" /></td><td></td></tr>
<tr><td>Field 2:</td><td><input id="txtField5" type="text" name="f22"/></td><td></td></tr>
<tr><td>Field 3:</td><td><input id="txtField6" type="text" name="f33"/></td><td></td></tr>
